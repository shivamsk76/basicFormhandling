...
if (reg.test(this.state.email)) {alert('form submitted');
...
First Name: <input type="text"  id="name" placeholder="first name" onChange={this.shivam} /> <br /> <br />
 Last  Name:  <input type="text"  id = "lastname" onChange={this.shivam}/> <br /><br />
 Mobile no.: <input type="number"  id="mobile" onChange={this.shivam}/>  <br /><br />
